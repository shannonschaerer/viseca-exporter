...
export declare function readFile(filepath: string, encoding: 'binary' | null): Promise<Buffer>;
export declare function readFile(filepath: string, encoding?: 'utf8'): Promise<string>;
export type ReadFile = typeof readFile;
export declare function writeFile(filepath: string, contents: string | ArrayBuffer | NodeJS.ArrayBufferView): Promise<undefined>;
