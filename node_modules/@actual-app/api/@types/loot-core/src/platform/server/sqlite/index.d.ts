...
export declare function runQuery(db: Database, sql: string, params?: (string | number)[], fetchAll?: false): {
    changes: unknown;
};
export declare function runQuery<T>(db: Database, sql: string, params: (string | number)[], fetchAll: true): T[];
